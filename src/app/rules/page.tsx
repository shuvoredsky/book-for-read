...
export default function RulesPage() {
  const rules = [
    ...
    {
      icon: CreditCard,
      title: "৪. পেমেন্ট ও এক্সেস অ্যাক্টিভেশন",
      description:
        "বইয়ের এক্সেস পেতে নির্ধারিত মাধ্যমে পেমেন্ট সম্পন্ন করে ট্রানজেকশন তথ্য সাবমিট করুন অথবা মেসেঞ্জারে যোগাযোগ করুন। এডমিন ভেরিফিকেশনের মাধ্যমে আপনার রিডার এক্সেস চালু (Active) করা হবে।",
